...
#define RE_SYNTAX_AWK                                                          \
	(RE_BACKSLASH_ESCAPE_IN_LISTS | RE_DOT_NOT_NULL | RE_NO_BK_PARENS |    \
	 ...
	 RE_CONTEXT_INDEP_ANCHORS | RE_UNMATCHED_RIGHT_PAREN_ORD |             \
	 RE_NO_GNU_OPS)
...
extern int re_match_2(struct re_pattern_buffer *__buffer, const char *__string1,
		      int __length1, const char *__string2, int __length2,
...
extern void re_set_registers(struct re_pattern_buffer *__buffer,
			     struct re_registers *__regs,
			     unsigned int __num_regs, regoff_t *__starts,
			     regoff_t *__ends);
#endif /* Use GNU */
