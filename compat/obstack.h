...
#define __PTR_ALIGN(B, P, A)                                   \
	(sizeof(PTR_INT_TYPE) < sizeof(void *) ?               \
		 __BPTR_ALIGN((B), (P), (A)) :                 \
		 (void *)__BPTR_ALIGN((PTR_INT_TYPE)(void *)0, \
				      (PTR_INT_TYPE)(P), (A)))
...
struct obstack /* control current object in current chunk */
{
	...
	unsigned maybe_empty_object : 1; /* There is a possibility that the
					  current chunk contains a zero-length
					  object.  This prevents freeing the
					  chunk if we allocate
...
#define obstack_chunkfun(h, newchunkfun) \
	((h)->chunkfun.extra =           \
		 (struct _obstack_chunk * (*)(void *, long))(newchunkfun))

#define obstack_freefun(h, newfreefun) \
	((h)->freefun.extra =          \
		 (void (*)(void *, struct _obstack_chunk *))(newfreefun))
