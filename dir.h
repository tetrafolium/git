...
int match_pathspec(const struct index_state *istate,
		   const struct pathspec *pathspec, const char *name,
		   int namelen, int prefix, char *seen, int is_dir);
...
int match_pathname(const char *, int, const char *, int, const char *, int, int,
		   unsigned);
