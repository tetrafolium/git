...
struct rev_info {
	...
	/* Traversal flags */
	unsigned int dense : 1, prune : 1, no_walk : 2, remove_empty_trees : 1,
		simplify_history : 1, show_pulls : 1, topo_order : 1,
	...
	unsigned int diff : 1, full_diff : 1, show_root_diff : 1,
		match_missing : 1, no_commit_id : 1, verbose_header : 1,
		always_show_header : 1,
		/* Diff-merge flags */
		explicit_diff_merges : 1, merges_need_diff : 1,
		separate_merges : 1, combine_merges : 1, combined_all_paths : 1,
		combined_imply_patch : 1, dense_combined_merges : 1,
		first_parent_merges : 1;

	/* Format info */
	int show_notes;
	unsigned int shown_one : 1, shown_dashes : 1, show_merge : 1,
		show_notes_given : 1, show_signature : 1, pretty_given : 1,
		abbrev_commit : 1, abbrev_commit_given : 1, zero_commit : 1,
		use_terminator : 1, missing_newline : 1, date_mode_explicit : 1,
		preserve_subject : 1, encode_email_headers : 1;
...
#define init_revisions(revs, prefix) \
