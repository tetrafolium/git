...
void strbuf_add_wrapped_text(struct strbuf *buf, const char *text, int indent,
 ...
 * ".git\0" and ".git/..." (but _not_ ".../.git"). This makes it suitable for
 * both fsck and verify_path().
 *
...
typedef enum { ALIGN_LEFT, ALIGN_MIDDLE, ALIGN_RIGHT } align_type;
