...
#define OPT_BIT_F(s, l, v, h, b, f)                                          \
	{                                                                    \
		OPTION_BIT, (s), (l), (v), NULL, (h), PARSE_OPT_NOARG | (f), \
			NULL, (b)                                            \
	}
#define OPT_COUNTUP_F(s, l, v, h, f)                      \
	{                                                 \
		OPTION_COUNTUP, (s), (l), (v), NULL, (h), \
			PARSE_OPT_NOARG | (f)             \
	}
#define OPT_SET_INT_F(s, l, v, h, i, f)                   \
	{                                                 \
		OPTION_SET_INT, (s), (l), (v), NULL, (h), \
			PARSE_OPT_NOARG | (f), NULL, (i)  \
	}
...
#define OPT_STRING_F(s, l, v, a, h, f)                      \
	{                                                   \
		OPTION_STRING, (s), (l), (v), (a), (h), (f) \
	}
#define OPT_INTEGER_F(s, l, v, h, f)                             \
	{                                                        \
		OPTION_INTEGER, (s), (l), (v), N_("n"), (h), (f) \
	}
...
#define OPT_ARGUMENT(l, v, h)                                             \
	{                                                                 \
		OPTION_ARGUMENT, 0, (l), (v), NULL, (h), PARSE_OPT_NOARG, \
			NULL, 1                                           \
	}
#define OPT_GROUP(h)                                   \
	{                                              \
...
#define OPT_BITOP(s, l, v, h, set, clear)                                     \
	{                                                                     \
		OPTION_BITOP, (s), (l), (v), NULL, (h),                       \
			PARSE_OPT_NOARG | PARSE_OPT_NONEG, NULL, (set), NULL, \
			(clear)                                               \
	}
#define OPT_NEGBIT(s, l, v, h, b)                                         \
	{                                                                 \
		OPTION_NEGBIT, (s), (l), (v), NULL, (h), PARSE_OPT_NOARG, \
			NULL, (b)                                         \
	}
...
#define OPT_CMDMODE(s, l, v, h, i)                                             \
	{                                                                      \
		OPTION_SET_INT, (s), (l), (v), NULL, (h),                      \
			PARSE_OPT_CMDMODE | PARSE_OPT_NOARG | PARSE_OPT_NONEG, \
			NULL, (i)                                              \
	}
#define OPT_INTEGER(s, l, v, h) OPT_INTEGER_F(s, l, v, h, 0)
#define OPT_MAGNITUDE(s, l, v, h)                                              \
	{                                                                      \
		OPTION_MAGNITUDE, (s), (l), (v), N_("n"), (h), PARSE_OPT_NONEG \
	}
...
#define OPT_FILENAME(s, l, v, h)                                \
	{                                                       \
		OPTION_FILENAME, (s), (l), (v), N_("file"), (h) \
	}
#define OPT_COLOR_FLAG(s, l, v, h)                                 \
	{                                                          \
		OPTION_CALLBACK, (s), (l), (v), N_("when"), (h),   \
			PARSE_OPT_OPTARG, parse_opt_color_flag_cb, \
			(intptr_t) "always"                        \
	}
...
NORETURN void usage_msg_opt(const char *msg, const char *const *usagestr,
			    const struct option *options);
...
enum parse_opt_result parse_opt_unknown_cb(struct parse_opt_ctx_t *ctx,
					   const struct option *, const char *,
					   int);
...
#define _OPT_CONTAINS_OR_WITH(name, variable, help, flag)                    \
	{                                                                    \
		OPTION_CALLBACK, 0, name, (variable), N_("commit"), (help),  \
			PARSE_OPT_LASTARG_DEFAULT | flag, parse_opt_commits, \
			(intptr_t) "HEAD"                                    \
	}
#define OPT_CONTAINS(v, h) \
	_OPT_CONTAINS_OR_WITH("contains", v, h, PARSE_OPT_NONEG)
...
#define OPT_CLEANUP(v)                          \
	OPT_STRING(0, "cleanup", v, N_("mode"), \
		   N_("how to strip spaces and #comments from message"))
#define OPT_PATHSPEC_FROM_FILE(v) \
	OPT_FILENAME(0, "pathspec-from-file", v, N_("read pathspec from file"))
#define OPT_PATHSPEC_FILE_NUL(v)           \
	OPT_BOOL(                          \
		0, "pathspec-file-nul", v, \
		N_("with --pathspec-from-file, pathspec elements are separated with NUL character"))
#define OPT_AUTOSTASH(v)            \
	OPT_BOOL(0, "autostash", v, \
