...
#define declare_commit_slab_prototypes(slabname, elemtype)                   \
                                                                             \
	void init_##slabname##_with_stride(struct slabname *s,               \
					   unsigned stride);                 \
	void init_##slabname(struct slabname *s);                            \
	void clear_##slabname(struct slabname *s);                           \
	void deep_clear_##slabname(struct slabname *s,                       \
				   void (*free_fn)(elemtype * ptr));         \
	elemtype *slabname##_at_peek(struct slabname *s,                     \
